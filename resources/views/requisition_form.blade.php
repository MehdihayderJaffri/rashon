...
<head>
    <title>Requisit Form | IRMS</title>
    <!--== META TAGS ==-->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item dropdown"><a href="#" class="text-white nav-link dropdown-toggle" id="navbardrop" data-toggle="dropdown">Family</a>
 ...
 -->
             ...
             <td>
                <div class="dropdown dropright">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="/rationapp/public/detailview/{{$person->id}}"><img src="https://img.icons8.com/color/48/000000/angry-eye--v2.png" width="20%"> View in Detail</a>

                      <a class="dropdown-item" href="/rationapp/public/approve/{{$person->id}}"><img src="https://img.icons8.com/color/48/000000/verified-account.png" width="20%"> Approved</a>
                      <!-- <i class='far fa-times-circle'> </i> -->
                       <a class="dropdown-item" href="/rationapp/public/reject/{{$person->id}}"> <!-- <i class='far fa-edit'> </i> --><img src="https://img.icons8.com/color/48/000000/cancel--v1.png" width="20%"> Reject</a>
                       <a class="dropdown-item" href="/rationapp/public/pending/{{$person->id}}"> <!-- <i class='far fa-edit'> </i> --><img src="https://img.icons8.com/color/48/000000/data-pending.png" width="20%"> Pending</a>
