...
<head>
    <title>Family Details | IRMS</title>
    <!--== META TAGS ==-->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item dropdown"><a href="#" class="active nav-link dropdown-toggle" id="navbardrop" data-toggle="dropdown">Families</a>
             ...
             <td>
                <div class="dropdown dropright">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <!-------------->
                      <a class="dropdown-item" href="/rationapp/public/stop/{{$person->id}}"><img src="https://img.icons8.com/color/48/000000/cancel-2--v2.png" width="20%"> Stop</a>
                      <!-- <i class='far fa-times-circle'> </i> -->
                       <a class="dropdown-item" href="/rationapp/public/up/{{$person->id}}"> <!-- <i class='far fa-edit'> </i> --><img src="https://img.icons8.com/color/48/000000/edit.png" width="20%"> Edit</a>
                       <a class="dropdown-item" href="rationapp/public/commit/{{$person->id}}"> <!-- <i class='far fa-edit'> </i> --><img src="https://img.icons8.com/color/48/000000/speech-bubble.png" width="20%"> Comment</a>
                      <a class="dropdown-item" href="/rationapp/public/deleting/{{$person->id}}"><!-- <i class='far fa-trash-alt'> </i> --><img src="https://img.icons8.com/color/48/000000/delete.png" width="20%"> Delete</a>
                      <!------>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header" style="background-color:#b3d7ff;">
          <h4 class="modal-title"><b>FR Form</b></h4>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <select class="form-control" name="package" required="required">
                                <option>Choose Package</option>
                                <option value="1">Package 1 (1637)</option>
                                <option value="2">Package 2 (2900)</option>
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            <span class="input-group-text">House Status</span>
                            </div>
                            <select class="form-control" name="houses" required="required">
                                <option>Choose house status</option>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="fhname" required="required">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-control" name="factor" required="required">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input class="form-control" name="files" type="file" multiple value="">
                        </div>

                        <div class="input-group mb-0 input-group-sm">
                            <label class="text-secondary" style="font-size: 12px; user-select: none;">Do you have another file? &nbsp;</label>
                            <input type="checkbox" id="chk-box"  onclick="FileCheck()">
                        </div>


                        <div id="2attachment" style="display: none; margin-top: 0px;">
                        <div class="input-group mb-3 input-group-sm" >
                            <div class="input-group-prepend">
                            <span class="input-group-text">Select another Image:</span>
                            </div>
                            <input class="form-control" name="files2" type="file" multiple="true" value="">
                        </div>

                        <!-- <div class="input-group mb-0 input-group-sm">
                            <label class="text-secondary" style="font-size: 12px; user-select: none;">Do you have more file? &nbsp;</label>
                            <input type="checkbox" id="chk-box2"  onclick="FileCheck2()">
                        </div> -->
                        </div>

                        <div id="3attachment" style="display: none; margin-top: 0px;">
                        <div class="input-group mb-3 input-group-sm" >
                            <div class="input-group-prepend">
                            <span class="input-group-text">Select another Image:</span>
                            </div>
                            <input class="form-control" name="files3" type="file" multiple="true" value="">
                        </div>

                        <script>
                                function FileCheck() {
                                  var checkBox = document.getElementById("chk-box");
                                  var sec_file = document.getElementById("2attachment");
                                  if (checkBox.checked == true){
                                    sec_file.style.display = "inline";
                                  } else {
