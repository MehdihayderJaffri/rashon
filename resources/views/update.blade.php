...
<body>
    ...
    <div class="container-fluid navbar pt-0 pb-0 navbar-dark navbar-expand-md bg-dark">
        ...
        <ul class="navbar-nav ">
            <!-- <li class="nav-item active"><a href="../public/person" class="nav-link">Person</a></li>
...
<div class="container mt-4">
  ...
  <!-- The Modal -->
        ...
        <!------Form Start------>
         @foreach ($persons as $UpdatePerson)

         
        <form action="/rationapp/public/updating/{{$UpdatePerson->id}}" method="POST" enctype="multipart/form-data">
        @csrf
        <!-- Modal Header -->
...
<!--         <div class="modal-body">
        -->
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" value="{{$UpdatePerson->name}}" name="name">
                        </div>
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <select class="custom-select" name="status">
                                <option selected="selected" value="{{$UpdatePerson->status}}">{{$UpdatePerson->status}}</option>
                                <?php

                    $rec_stat = $UpdatePerson->status;
                    ...
                    <?php
                     ...
                     ?>
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="noofperson" value="{{$UpdatePerson->no_of_person}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            ...
                            <select class="form-control" name="package">
                               <option selected="selected" value="{{$UpdatePerson->package_id}}">{{$UpdatePerson->package_id}}</option>

                                <?php

                    $pkg_id = $UpdatePerson->package_id;
                    ...
                    <?php
                     ...
                     ?>
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="address" value="{{$UpdatePerson->address}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            ...
                            <select class="form-control" name="houses">

                        
                                 <?php

                    $hos_S = $UpdatePerson->house;


                    if ($hos_S == 'Rental') {

                     ?>
                      <option selected="selected" value="Rental">Rental</option>
                    ...
                    elseif ($hos_S == '') {
                    ?>
                    <option>Choose House Status Now</option>
                    <option value="Owned">Owned</option>
                     <option value="Rental">Rental</option>
                     ...
                     ?>
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <?php
                                    ...
                                    $st_date = $UpdatePerson->start_date;
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <span class="input-group-text">Re-Survey Date</span>
                             ...
                             <?php
                                    ...
                                    $sr_date = $UpdatePerson->survey_date;
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="timeperiod" value="{{$UpdatePerson->time_period}}">
                        </div>
                        <!------------------>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="fhname" value="{{$UpdatePerson->fh_name}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-control" name="factor" value="{{$UpdatePerson->factor}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-control" name="sonage" value="{{$UpdatePerson->son_age}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                    ...
                    <?php
                     ...
                     ?>
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="nicno" value="{{$UpdatePerson->nic_no}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            ...
                            <?php
                                    ...
                                    $ex_date = $UpdatePerson->extension_date;
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <?php
                                    ...
                                    $rs_date = $UpdatePerson->re_survey_date;
                             ...
                             ?>
                            <input class="form-control" name="resurveydate" type="date" value="{{$UpdatePerson->re_survey_date}}"><!-- id="example-datetime-local-input" -->
            ...
            <button type="button" class="btn btn-secondary float-right mr-2"><a style="text-decoration: none; color: white;" href="{{ url()->previous() }}">Cancel</a></button>
        </div>
        
        <!-- Modal footer -->
       <!--  <div class="modal-footer"> -->
           <!--  <input type="submit" value="Update" class="btn btn-success">
            <button type="button" class="btn btn-secondary"><a style="text-decoration: none; color: white;" href="{{ url()->previous() }}">Cancel</a></button> -->
        <!-- </div> -->
