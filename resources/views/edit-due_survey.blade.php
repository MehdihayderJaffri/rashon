...
<head>
    <title>Edit Due Survey | IRMS</title>
    <!--== META TAGS ==-->
    <meta charset="utf-8">
...
<div class="container mt-4">
  ...
  <!-- The Modal -->
        ...
        <!------Form Start------>
         @foreach ($edit_due_survey as $eds)

         
        <form action="/rationapp/public/updating_due_survey/{{$eds->id}}" method="POST" enctype="multipart/form-data">
        @csrf
        <!-- Modal Header -->
        
          <h4><b>Edit Due Survey Details:</b></h4>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" value="{{$eds->name}}" name="name">
                        </div>
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <select class="custom-select" name="status">
                                <option selected="selected" value="{{$eds->status}}">{{$eds->status}}</option>
                                <?php
                    ...
                    <?php
                     ...
                     ?>
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="noofperson" value="{{$eds->no_of_person}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            ...
                            <select class="form-control" name="package">
                               <option selected="selected" value="{{$eds->package_id}}">{{$eds->package_id}}</option>

                                <?php

                    $pkg_id = $eds->package_id;
                    ...
                    <?php
                     ...
                     ?>
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="address" value="{{$eds->address}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            ...
                            <?php
                                    ...
                                    $st_date = $eds->start_date;
                                    $st1 = new DateTime($st_date);
                                    $st2 = $st1->format('d-M-Y');

                             ?>
                            <input class="form-control" name="startdate" type="date" value="{{$st_date}}" id="example-datetime-local-input">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="timeperiod" value="{{$eds->time_period}}">
                        </div>
                        <!------------------>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="fhname" value="{{$eds->fh_name}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-control" name="factor" value="{{$eds->factor}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-control" name="sonage" value="{{$eds->son_age}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                    ...
                    <?php
                     ...
                     ?>
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" name="nicno" value="{{$eds->nic_no}}">
                        </div>
                        <!------------------>
                        <div class="input-group mb-3 input-group-sm">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group mb-3 input-group-sm">
                            ...
                            <?php
                                    ...
                                    // $rsvy_date = $eds->re_survey_date;
                                    // $rsvy1 = new datetime($rsvy_date);
                                    // $rsvy2 = $rsvy1->format('d-M-Y')
                                    $rs_date = $eds->re_survey_date;
                             ...
                             ?>
                            <input class="form-control" name="resurveydate" type="date" value="{{$eds->re_survey_date}}"><!-- id="example-datetime-local-input" -->
                        </div>
                    </div>
